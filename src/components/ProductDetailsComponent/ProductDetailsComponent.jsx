...
import {WrapperStyleImageSmall,WrapperStyleColSmall,WrapperStyleNameProduct,WrapperStyleTextSell,WrappePriceProduct,WrappePriceTextProduct,WrapperAddressProduct,WrapperQualityProduct,WrapperInputNumber} from "./style";
    ...
    return (
        <Row style={{ padding: '16px', background: '#fff', borderRadius:'4px' }}>
            ...
            <Col span={14} style={{paddingLeft:'20px'}}>
                <WrapperStyleNameProduct >Kệ Sách Gỗ Đa Tầng FIVO</WrapperStyleNameProduct>
